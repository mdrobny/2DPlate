...
fatcat:
	/opt/nfs/mpich-3.0.2/bin/mpicxx -DSIMPLE_SPRNG -DUSE_MPI proj1.c -I/opt/nfs/sprng4/include -I/opt/nfs/mpe2-1.3.0/include -L/opt/nfs/sprng4/lib -L/opt/nfs/mpe2-1.3.0/lib -lsprng -lmpe -lX11 -lm
fatcat-mmpe:
